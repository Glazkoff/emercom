    ...
    <div class="main-screen">
      ...
      <div class="main main-panel centered-wrapper">
        <div class="col">
          ...
          <div class="info-block scroll-bar rounded-corners">
            <div class="message-box rounded-corners">
              ...
              <h3>Общий сбор</h3>
              <p>В главном штабе будет собрание. Быть всем! Текст, текст. Текст, текст.</p>
            </div>
            <div class="message-box rounded-corners">
              <h4>08.02.2020, 13:45</h4>
              <h3>Общий сбор</h3>
        ...
        <div class="col">
          ...
          <div class="info-block scroll-bar rounded-corners">
            <router-link to="write" tag="button" class="add-btn rounded-corners"><span class="nav-logo cross"></span>Добавить заявку</router-link>
            <div class="message-box rounded-corners">
...
.bottom-btn {
  ...
  left: 0;
  width: calc(100% - 10px);
  background: linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(0,0,0,.6) 100%);
  text-align: center;
  height: 40px;
